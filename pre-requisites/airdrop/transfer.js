...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var balance, transaction, _a, fee, signature, finalBalance, finalBalanceTo, e_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                balance = _b.sent();
                console.log("Your wallet balance is ".concat(balance / web3_js_1.LAMPORTS_PER_SOL, " SOL"));
            ...
            case 5:
                ...
                console.log("Your final wallet balance is ".concat(finalBalance / web3_js_1.LAMPORTS_PER_SOL, " SOL"));
                return [4 /*yield*/, connection.getBalance(to)];
            case 6:
                finalBalanceTo = _b.sent();
                console.log("Your final wallet balance is ".concat(finalBalanceTo / web3_js_1.LAMPORTS_PER_SOL, " SOL"));
                return [3 /*break*/, 8];
            case 7:
                e_1 = _b.sent();
